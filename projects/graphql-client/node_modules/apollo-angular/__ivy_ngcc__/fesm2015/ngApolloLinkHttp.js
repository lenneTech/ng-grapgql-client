...
HttpLink.ɵprov = ɵɵdefineInjectable({ factory: function HttpLink_Factory() { return new HttpLink(ɵɵinject(HttpClient)); }, token: HttpLink, providedIn: "root" });
...
HttpBatchLink.ɵprov = ɵɵdefineInjectable({ factory: function HttpBatchLink_Factory() { return new HttpBatchLink(ɵɵinject(HttpClient)); }, token: HttpBatchLink, providedIn: "root" });
HttpBatchLink.ctorParameters = () => [
    { type: HttpClient }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(HttpBatchLink, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
